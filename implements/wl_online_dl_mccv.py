"""Monte Carlo CV benchmark for WL + Online DL (scikit-learn).
...
implements/wl_aksvd_mccv.py and implements/wl_fddl_gpu_mccv.py so every arm is
produced by identical machinery and only the dictionary learner differs.

Usage
-----
    python implements/wl_online_dl_mccv.py                 # full run
    python implements/wl_online_dl_mccv.py --seed 7 --out-dir results/<run>
    python implements/wl_online_dl_mccv.py --aggregate --out-dir results/<run>
"""
