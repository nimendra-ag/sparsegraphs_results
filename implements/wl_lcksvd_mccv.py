"""Monte Carlo CV benchmark for WL + LC-KSVD.
...
Usage
-----
    python implements/wl_lcksvd_mccv.py                 # full run
    python implements/wl_lcksvd_mccv.py --seed 7 --out-dir results/<run>
    python implements/wl_lcksvd_mccv.py --aggregate --out-dir results/<run>
"""
