"""Monte Carlo CV benchmark for WL + Bayesian dictionary learning (BPFA).
...
Usage
-----
    python implements/wl_bayesian_mccv.py                 # full run
    python implements/wl_bayesian_mccv.py --seed 7 --out-dir results/<run>
    python implements/wl_bayesian_mccv.py --aggregate --out-dir results/<run>
"""
...
if __name__ == "__main__":
    mccv.main(
        ...
        dict_learner_factory=lambda seed: BayesianDL(seed=seed),
